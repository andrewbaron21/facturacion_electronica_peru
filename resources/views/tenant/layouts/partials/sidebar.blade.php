...
<aside id="sidebar-left" class="sidebar-left">
            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                                ...
                                {{ $firstLevel === 'dispatch_addresses' ? 'nav-active nav-expanded' : '' }}">
                                    ...
                                    <ul class="nav nav-children" style="">
                                        ...
                                        <li class="{{ ($firstLevel === 'dispatch_addresses')?'nav-active':'' }}">
                                            <a class="nav-link"
                                               href="{{route('tenant.dispatch-addresses.index')}}">Direcciones de
                                               llegada</a>
                                        </li> --}}
                                    </ul>
                                </li>
                    ...
                    @if (in_array('suscription_app', $vc_modules))
                        <li
                            class=" nav-parent {{ $firstLevel === 'suscription' ? 'nav-active nav-expanded' : '' }}">
                            <a class="nav-link" href="#">
                                <i class="fa fas fa-calendar-check" aria-hidden="true"></i>
                    ...
                    @if (in_array('restaurant_app', $vc_modules))
                        <li
                            class=" nav-parent {{ $firstLevel === 'restaurant' ? 'nav-active nav-expanded' : '' }}">
                            <a class="nav-link" href="#">
                                <i class="fas fa-utensils" aria-hidden="true"></i>
                                <span>Restaurante <sup
                                        style="background: #ffc300;padding: 0px 3px;border-radius: 4px;">Beta</sup></span>
                            </a>
                            <ul class="nav nav-children">
                                ...
                                <li class="nav-parent">
                                    ...
                                    <ul class="nav nav-children">
                                        <li>
                                            <a class="nav-link" href="{{ route('orders.createView') }}">
                                                Crear Pedido
                                            </a>
                                        </li>
                                        <li>
                                            <a class="nav-link" href="{{ route('orders.waiters') }}">
                                                Gestionar Pedidos Mesero
                                            </a>
                                        </li>
                                        <li>
                                            <a class="nav-link" href="{{ route('orders.ready') }}">
                                                Pedidos Listos
                                            </a>
                                        </li>
                                    </ul>
    ...
    @if (in_array('users_establishments', $vc_module_levels) ||
            in_array('users', $vc_module_levels) ||
            in_array('configuration', $vc_modules) ||
            in_array('app_2_generator', $vc_modules) ||
            in_array('apps', $vc_modules))
        <div class="more-config">
            ...
            <ul class="nav list-config">
                ...
                @if (in_array('users', $vc_module_levels))
                    <li>
                        <a class="nav-link" href="{{ route('tenant.users.index') }}"><i class="fas fa-users"></i>
                            Usuarios</a>
                    </li>
                @endif
                @if (in_array('users_establishments', $vc_module_levels))
                    <li>
                        <a class="nav-link" href="{{ route('tenant.establishments.index') }}"><i
                                class="fas fa-list-ol"></i> Locales & Series</a>
                    </li>
                @endif
                @if (in_array('app_2_generator', $vc_modules))
                    <li>
                        <a class="nav-link" href="{{ route('tenant.liveapp.configuration') }}">
                            <i class="fas fa-mobile"></i> APP 3.0
                        </a>
                    </li>
                @endif
                ...
                @if (in_array('configuration', $vc_modules))
                    <li
                        ...
                        <a class="nav-link" href="{{ url('list-settings') }}"><i class="fas fa-toolbox"></i>
