                    ...
                    <el-tab-pane class="mb-3" name="second">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-4">
                                ...
                                <div :class="{'has-danger': errors.condition_sale_purchase_price_to_item}" class="form-group">
                            ...
                            <div class="col-md-6 mt-4">
                               ...
                               <div :class="{'has-danger': errors.enabled_price_items_dispatch}"
                                       class="form-group">
                                   <el-switch v-model="form.enabled_price_items_dispatch"
                                       active-text="Si"
                                       inactive-text="No"
                                       @change="submit"></el-switch>
                                   <small v-if="errors.enabled_price_items_dispatch"
                        ...
                        <div class="row">
                            <div class="col-md-4 mt-4">
                                <div class="form-group">
                                    ...
                                    <div :class="{'has-danger': errors.show_bank_accounts_in_pdf}"
                                            class="form-group">
                                        <el-switch v-model="form.show_bank_accounts_in_pdf"
                                                    active-text="Si"
                                                    inactive-text="No"
                                                    @change="submit"></el-switch>
                                        <small v-if="errors.show_bank_accounts_in_pdf"
                                                class="form-control-feedback"
                            ...
                            <div class="col-md-4 mt-4">
                                <div class="form-group">
                                    ...
                                    <div :class="{'has-danger': errors.show_seller_in_pdf}"
                                            class="form-group">
                                        <el-switch v-model="form.show_seller_in_pdf"
                                                    active-text="Si"
                                                    inactive-text="No"
                                                    @change="submit"></el-switch>
                                        <small v-if="errors.show_seller_in_pdf"
                                                class="form-control-feedback"
