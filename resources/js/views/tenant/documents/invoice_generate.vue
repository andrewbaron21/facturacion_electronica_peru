    ...
    <div>
        ...
        <div v-if="loading_form">
            <form autocomplete="off"
                ...
                <div class="col-xl-12 col-md-12 col-12">
                    ...
                    <div class="card-body border-top no-gutters">
                        <template v-if="showSearchItemsMainForm">
                            <div class="row">
                                <div class="col-md-9 mb-4" :class="{'col-md-12': configuration.enable_list_product}">
                ...
                <el-collapse v-model="activePanel" accordion class="mb-2">
                    <el-collapse-item name="1">
                        <template slot="title">
                            <span class="ml-2">Información Adicional</span>
                        </template>
                        <div class="card-transparent col-xl-12 col-md-12 col-12 mt-0 mb-4">
                             <div class="row">
                            ...
                            <div class="col-12 col-md-4 p-2">
                                ...
                                <template v-if="!is_client">
                                    ...
                                    <div class="col-12 py-2 px-0">
                                        <div class="row no-gutters">
                                            <div class="col-10"> Mostrar términos y condiciones.</div>
                                            <div class="col-2">
                            ...
                            <div class="col-12 col-md-4 p-2 no-gutters">
                                <div class="col-12">
                        ...
                        <div class="table-responsive" v-loading="loading_items">
                            <table class="table table-sm">
                                ...
                                <tr>
                                    ...
                                    <th v-if="config.change_free_affectation_igv" width="8%"></th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr v-for="(row, index) in form.items"
                                    ...
                                    <td>
                                        ...
                                        <p class="control-label font-weight-bold text-info">
                                            <a v-if="configuration.show_all_item_details" class="btn btn-default btn-xs" href="#" @click.prevent="clickShowItemDetail(row.item_id)">Ver detalle</a>
                                            <button class="btn waves-effect waves-light btn-xs btn-outline-info"
                                                type="button"
                                                @click="ediItem(row, index)">
                                            <i class="fas fa-edit"></i></button>
                                            <button class="btn waves-effect waves-light btn-xs btn-outline-danger"
                                                type="button"
                                    ...
                                    <td class="text-right">
                                        <template v-if="showEditableItems">
                                            <span class="currency">{{ currency_type.symbol }}</span>
                                            <div @keydown.enter="handleEnterKey($event)">
                                                <el-input-number
                                        ...
                                        <template v-else>
                                            {{ currency_type.symbol }} {{ getFormatUnitPriceRow(row.unit_value) }}
                                        </template>
                                    </td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <template v-else>
                                            {{ currency_type.symbol }} {{ getFormatUnitPriceRow(row.unit_price) }}
                                        </template>
                                    </td>
                                ...
                                <table class="table table-sm text-right"
                                    ...
                                    <tr v-if="form.total > 0">
                                        ...
                                        <td class="p-0"
                                            ...
                                            <!-- Contado -->
                                            <div v-if="!is_receivable && form.payment_condition_id === '01'" class="table-responsive payment">
    ...
    methods: {
        ...
        setItemFromResponse(item, itemsParsed, sum_quantity = false)
        {
            ...
            if(itemsParsed.length) {
                let itemParsed = itemsParsed.find(element => element.id == item.item.id);
        ...
        async changeDetractionType() {
            ...
            if (this.form.detraction) {
                ...
                if (this.form.currency_type_id == 'PEN') {
                    ...
                    this.form.detraction.amount = _.round(parseFloat(this.form.total) * (parseFloat(this.form.detraction.percentage) / 100), round)
                    ...
                    this.form.detraction.amount = _.round((parseFloat(this.form.total) * this.form.exchange_rate_sale) * (parseFloat(this.form.detraction.percentage) / 100), round)
        ...
        async validatePreview(){
            ...
            if (this.is_receivable) {
                ...
                let validate = await this.validate_payments()
                if (validate.acum_total > parseFloat(this.form.total) || validate.error_by_item > 0) {
                    this.$message.error('Los montos ingresados superan al monto a pagar o son incorrectos');
                    return false;
                }
