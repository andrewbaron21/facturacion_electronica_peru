            ...
            <el-tab-pane class="mb-3"  name="first">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="row mt-3">
                    <div class="col-md-12">
                      <h4>Habilitar botones en Comanda</h4>
                    </div>
                    <div class="col-md-4">
                      <label class="control-label">
                        Enviar a comanda
                        ...
                        <tr v-for="user in users" :key="user.id">
                          ...
                          <td>
                            ...
                            <template v-else-if="user.restaurant_role_code == 'MOZO'">
                              <el-tag type="warning" v-for="(item, index) in permission_mozo" :key="index + 'MOZO'">{{ item }} 
                                <el-tooltip class="item"
                                            content="Para habilitar acceso a Comandas y POS, ingresar a Configuración/Restaurante  Permisos adicionales"
                                            effect="dark"
                                            placement="top-start">
