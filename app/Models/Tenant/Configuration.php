    ...
    class Configuration extends ModelTenant
    {
        ...
        public function getCollectionData()
        {
            ...
            return [
                ...
                'qr_api_url' => $this->qr_api_url,
                'qr_api_apiKey' => $this->qr_api_apiKey,
                'qr_api_enable' => $this->qr_api_enable,
        ...
        {
            return $query->select('show_seller_in_pdf', 'show_bank_accounts_in_pdf')->first();
        }
